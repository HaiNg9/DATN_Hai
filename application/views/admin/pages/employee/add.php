            ...
            <div class="card-body">
                ...
                <form action="admin/employee/create" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input value="<?= $old['name'] ?? '' ?>" name="name" type="text" class="form-control" placeholder="Nhập tên nhân viên">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <img id="img-show" style="width: 255px; height: 300px;" id="img-show" src="public/admin/upload/images/employee/default.png" class="img-fluid" alt="Hình đại diện." >
                    </div>
